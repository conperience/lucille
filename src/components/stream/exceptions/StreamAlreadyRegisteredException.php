...
/**
 * Class StreamAlreadyRegisteredException
 *
 * @package Lucille\Components\Stream\Exceptions
 */
class StreamAlreadyRegisteredException extends LucilleException {
    ...
    public function __construct(StreamName $protocolName) {
        parent::__construct('Stream for protocol '.$protocolName->asString().' is already registered');
